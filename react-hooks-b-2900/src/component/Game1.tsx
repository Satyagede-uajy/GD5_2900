...
export default function Game1() {
  ...
  // Mengambil high score dari localStorage saat pertama kali dimuat
  useEffect(() => {
  ...
  // Timer untuk kemunculan tikus acak
  useEffect(() => {
  ...
  // Timer khusus untuk hitung mundur waktu (tanpa efek samping)
  useEffect(() => {
  ...
  useEffect(() => {
    if (gameActive && time === 0) {
      setGameActive(false);
      setMoleIndex(null); // Sembunyikan tikus
